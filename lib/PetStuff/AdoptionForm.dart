...
class _AdoptionFormState extends State<AdoptionForm>{
  ...
  List <String> dogList = ['Akita','American Pit Bull Terrier','Beagle','Boxer','Bull Terrier','Bulldog','Chihuahua',
    ...
    'Pomeranian','Poodle','Pug','Rottweiler','Samoyed','Shiba Inu','Shih Tzu','Siberian Husky','St. Bernard','Unknown'];
  List catList = ['Abyssinian','American Bobtail','American Curl','American Shorthairs','Bengal Cat','Birman',
    ...
    'Persian Cat', 'Ragdoll','Scottish fold','Siamese','Singapura','Somali','Spotted Cat','Unknown'];
      ...
      body: SingleChildScrollView(
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
              Text("Pet Adoption\n Registration", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 30)),
              SizedBox(height: 45,),
              userImage(),
              Container(
  ...
  Future _uploadFile() async {
    ...
    if(path!=null){
      final ref = FirebaseStorage.instance.ref().child('Pet Adoption Pictures').child("pet_$petId.jpg");
  ...
  savePetInfoToFireStore() {
    FirebaseFirestore.instance.collection('adoption')
      ...
      "ownerUrl" : currentUser.url,
      'url':imageUrl,
      'owner': currentUser.username,
      'members': {currentUser.id: false},
