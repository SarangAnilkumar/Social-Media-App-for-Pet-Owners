      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
              ...
              children: <Widget>[
                Text("Log In", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 30)),
                SizedBox(height: 10,),
                Text("Log in with one of the following options", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 15)),
                SizedBox(height: 30,),
                Column(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text("Don't have an account?", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 15)),
                      TextButton(
