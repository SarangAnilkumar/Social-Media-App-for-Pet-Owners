          ...
          child: Column(
            ...
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
              children: <Widget>[
                ...
                SizedBox(height: 10,),
                Text("Sign Up with one of the following options", style: Theme.of(context).textTheme.headline1.copyWith(fontSize: 15)),
                SizedBox(height: 30,),
             Column(
               ...
               children: [
                 Row(
                   ...
                   children: <Widget>[
                     TextButton(onPressed: (){}, child: Image(
                         width: 40,
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Ink(
                      decoration: BoxDecoration(
                          gradient: LinearGradient(colors: [Colors.pink, Colors.purpleAccent],begin: Alignment.centerLeft,end: Alignment.centerRight,),
